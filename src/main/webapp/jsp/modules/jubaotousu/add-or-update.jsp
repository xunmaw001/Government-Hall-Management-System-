...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑举报投诉</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑举报投诉</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">举报投诉信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>投诉单号</label>
										<input id="tousudanhao" name="tousudanhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>投诉内容</label>
	...
	<script>
		...
		var crossRuleForm = {};
			...
			function tousudanhaoUuid(){
				if($("#tousudanhao").val() == null || $("#tousudanhao").val() == "null" || $("#tousudanhao").val() == ""){
					$("#tousudanhao").attr("value",Math.round(new Date().getTime()/1000));
				}
			}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jubaotousu/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("jubaotousu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			...
			$("#tousudanhao").val(ruleForm.tousudanhao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tousudanhao != null && res.data.tousudanhao != ''){

					$("#tousudanhao").val(res.data.tousudanhao);
					}
