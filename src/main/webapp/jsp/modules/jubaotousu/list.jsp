...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">举报投诉管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>举报投诉管理</span></li>
								<li class="breadcrumb-item active"><span>举报投诉列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">举报投诉列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										投诉单号
									</label>
									<input type="text" id="tousudanhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tousudanhao')">投诉单号<i id="tousudanhaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#tousudanhaoSearch').val() != null && $('#tousudanhaoSearch').val() != ''){
				searchForm.tousudanhao ="%" +  $('#tousudanhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jubaotousu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				tousudanhao : searchForm.tousudanhao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var tousudanhaoCell  = document.createElement('td');

						 tousudanhaoCell.innerHTML = item.tousudanhao;


			row.appendChild(tousudanhaoCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("jubaotousu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("jubaotousu/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jubaotousu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jubaotousu");
