          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="tousudanhao" id="tousudanhao" placeholder="投诉单号" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('jubaotousu','新增')" @click="jump('../jubaotousu/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../jubaotousu/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#tousudanhao').val()) {
          param['tousudanhao'] = jquery('#tousudanhao').val() ? '%' + jquery('#tousudanhao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jubaotousu/list', 'get', param, function(res) {
