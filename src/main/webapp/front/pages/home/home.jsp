...
<body>
    ...
    <div class="plate">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in dangyuanfengcaiList" v-bind:key="index">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in zhengcexinxiList" v-bind:key="index">
                <a target="_self" :href="'../zhengcexinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`zhengcexinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.zhengcexinxiList = res.data.list;
      });
    });
  </script>
</body>
