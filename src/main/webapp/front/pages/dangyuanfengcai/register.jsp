      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="dangyuanxingming" name="dangyuanxingming" placeholder="请输入党员姓名" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="rudangshijian" name="rudangshijian" placeholder="请输入入党时间" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
