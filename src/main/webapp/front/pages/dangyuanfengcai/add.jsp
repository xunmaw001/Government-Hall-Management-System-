			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.dangyuanxingming" type="text" name="dangyuanxingming" id="dangyuanxingming" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.rudangshijian" type="text" name="rudangshijian" id="rudangshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                        
                                                                                                                                                                                    <div class="layui-form-item" pane>
						<label class="layui-form-label">党员风采：</label>
						<div class="layui-input-block">
							<textarea name="dangyuanfengcai" id="dangyuanfengcai">请输入党员风采</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var dangyuanfengcai = tinymce.get('#dangyuanfengcai').getContent()
					data.dangyuanfengcai = dangyuanfengcai;
					...
					// 提交数据
					http.requestJson('dangyuanfengcai' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
