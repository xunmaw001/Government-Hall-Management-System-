          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="dangyuanxingming" id="dangyuanxingming" placeholder="党员姓名" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('dangyuanfengcai','新增')" @click="jump('../dangyuanfengcai/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../dangyuanfengcai/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.touxiang?item.touxiang.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.dangyuanxingming}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#dangyuanxingming').val()) {
          param['dangyuanxingming'] = jquery('#dangyuanxingming').val() ? '%' + jquery('#dangyuanxingming').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('dangyuanfengcai/list', 'get', param, function(res) {
